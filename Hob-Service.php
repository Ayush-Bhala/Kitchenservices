      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="#our-services">Services</a>
            <ul>
              <li class="menu-active"><a href="Hob-Service.php" title="Hob Service &amp; Repair">Hob Service &amp; Repair</a></li>
    ...
    <section id="call" class="top_pad">
      <div class="container">
        ...
        <header class="section-header">
            <h3 class="hobs">
                <span class="banner_text">For Hob Service &amp; Repair <br>Call<a href="tel:18001200489"> <i class="fa fa-phone" style="padding-right:5px;"></i>18001200489</a> </span>
                </h3>
        </header><hr>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2 hobsservice">
              <p>In a kitchen, hob is a shelf or a surface for holding food or utensils in order to cook or to keep them warm. It is sometimes referred to as a cook top or hotplate. For Indian kitchens, this is a new and developing concept and more and more people are opting for it for a complete modular and sophisticated look of the kitchen. The hob parts and components are complex and are less available at places. With this, it requires due care and careful service from time to time. We specialize in hob services and repairs and are associated with dealers of parts of complicated hob installations. We have trained service staff which gives you an opportunity of saving your precious time and getting service and repairs requested at your doorstep. We use latest service tools and techniques so that our customers trust us even more with passing time. We Give Service And Repair All Brands Like Kaff, Faber, GLEN, Elica etc. We provide 24*7 service and repairs for your equipment's breakout in the midst of the night. Call us and book a service/ repairs request with us!
              </p>

          </div>

          <div class="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
            <img src="img/kitchen/hob.jpg" class="img-fluid" alt="">
          </div>
        </div>
