  ...
  <main id="main">
    ...
    <section id="call" class="top_pad">
      <div class="container">
        ...
        <header class="section-header">
            <h3 class="hobs">
                <span class="banner_text">For Gas Stove Repair & Service <br>Call<a href="tel:18001200489"> <i class="fa fa-phone" style="padding-right:5px;"></i>18001200489</a> </span>
                </h3>
        </header><hr>
      </div>
    </section>
    ...
    <section id="about" class="top_pad">
      <div class="container">
        ...
        <header class="section-header">
          <h3>Gas Stove Repair & Service</h3>
        </header>

        <div class="row about-container">

          <div class="col-lg-6 content order-lg-1 order-2 hobsservice">
              <p>Gas stoves are myriad in qualities and brands. Each gas stove has different parts and components. We need to look into the core components of gas stoves for which we have a well trained team. We convert your gas stove from a one compatible with an LPG cylinder to one compatible with a gas pipeline and vica-versa. The cook top or a gas stove looks after your meal blues day and night. The lady of the house should never struggle with a malfunctioning gas stove. Kitchenservice4u is here with the service and repairs of your gas stove. We have trained service staff which gives you an opportunity of saving your precious time and getting service and repairs requested at your doorstep. We specialize in gas stove services and repairs and are associated with dealers of parts of gas stove. We use latest service tools and techniques so that our customers trust us even more with passing time. We Give Service And Repair All Brands Like Kaff, Faber, GLEN, Elica etc. We provide 24*7 service and repairs for your equipment's breakout in the midst of the night. Call us and book a service/ repairs request with us!
              </p>

          </div>

          <div class="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
            <img src="img/kitchen/gas_stove.jpg" class="img-fluid" alt="">
          </div>
        </div>
